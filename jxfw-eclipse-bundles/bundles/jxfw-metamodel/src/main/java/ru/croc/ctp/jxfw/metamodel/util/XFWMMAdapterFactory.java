 ...
 * @generated
 */
public class XFWMMAdapterFactory extends AdapterFactoryImpl {
	/**
	...
	protected XFWMMSwitch<Adapter> modelSwitch =
		new XFWMMSwitch<Adapter>() {
			@Override
			public Adapter caseXFWPackage(XFWPackage object) {
				return createXFWPackageAdapter();
			}
			@Override
			public Adapter caseXFWClass(XFWClass object) {
				return createXFWClassAdapter();
			}
			@Override
			public Adapter caseXFWAttribute(XFWAttribute object) {
				return createXFWAttributeAdapter();
			}
			@Override
			public Adapter caseXFWReference(XFWReference object) {
				return createXFWReferenceAdapter();
			}
			@Override
			public Adapter caseXFWDataSource(XFWDataSource object) {
				return createXFWDataSourceAdapter();
			}
			@Override
			public Adapter caseXFWOperation(XFWOperation object) {
				return createXFWOperationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ru.croc.ctp.jxfw.metamodel.XFWPackage <em>XFW Package</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXFWPackageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.croc.ctp.jxfw.metamodel.XFWClass <em>XFW Class</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXFWClassAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.croc.ctp.jxfw.metamodel.XFWAttribute <em>XFW Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXFWAttributeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.croc.ctp.jxfw.metamodel.XFWReference <em>XFW Reference</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXFWReferenceAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.croc.ctp.jxfw.metamodel.XFWDataSource <em>XFW Data Source</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXFWDataSourceAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.croc.ctp.jxfw.metamodel.XFWOperation <em>XFW Operation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXFWOperationAdapter() {
		return null;
	}
