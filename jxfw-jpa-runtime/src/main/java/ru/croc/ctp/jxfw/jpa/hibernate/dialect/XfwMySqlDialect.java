...
import ru.croc.ctp.jxfw.jpa.hibernate.impl.sql.MySqlBitwiseAndSqlFunction;

/**
 * Расширение диалекта для MySQL
 *
 * @author Nosov Alexander
 *         on 22.05.15.
 */
public class XfwMySqlDialect extends MySQLDialect {
     ...
     */
    public XfwMySqlDialect() {
        super();
        registerFunction(BITWISE_AND_FUNCTION_NAME,
                new MySqlBitwiseAndSqlFunction(BITWISE_AND_FUNCTION_NAME, StandardBasicTypes.INTEGER));
    }
