...
/**
 * Класс, инкапсулирующий область XSL-FO элемента &lt;fo:table-footer&gt;.
 * Created by vsavenkov on 27.07.2017. Import from $/Крок.R-and-D.ReportRenderers/Sources/Repo-1_1.
 */
public class TableFooterArea extends CellGridContainer {
     ...
     */
    public TableFooterArea(IArea parentArea, Map<String, String> attributeList) throws XslFoException {
