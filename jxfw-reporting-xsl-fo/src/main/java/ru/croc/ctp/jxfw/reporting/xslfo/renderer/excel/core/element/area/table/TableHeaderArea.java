...
/**
 * Класс, инкапсулирующий область XSL-FO элемента &lt;fo:table-header&gt;.
 * Created by vsavenkov on 27.07.2017. Import from $/Крок.R-and-D.ReportRenderers/Sources/Repo-1_1.
 */
public class TableHeaderArea extends CellGridContainer {
     ...
     */
    public TableHeaderArea(IArea parentArea, Map<String, String> attributeList) throws XslFoException {
