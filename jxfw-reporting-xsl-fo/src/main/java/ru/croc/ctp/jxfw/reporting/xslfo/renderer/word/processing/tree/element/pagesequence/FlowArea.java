...
/**
 * Класс, инкапсулирующий обработку элемента fo:flow.
...
public class FlowArea extends GenericArea {
     ...
     */
    public FlowArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.FLOW, parentArea, attributeList);
    }
}
