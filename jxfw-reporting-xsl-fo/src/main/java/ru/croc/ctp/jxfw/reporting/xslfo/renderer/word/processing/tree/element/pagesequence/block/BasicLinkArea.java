...
/**
 * Класс, инкапсулирующий обработку элемента fo:basic-link.
 * Created by vsavenkov on 06.07.2017. Import from $/Крок.R-and-D.ReportRenderers/Sources/Repo-1_1.
 */
public class BasicLinkArea extends GenericArea {
     ...
     */
    public BasicLinkArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.BASIC_LINK, parentArea, attributeList);
    }
}
