...
/**
 * Класс, инкапсулирующий обработку элемента fo:block.
...
public class BlockArea extends GenericArea {
     ...
     */
    public BlockArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.BLOCK, parentArea, attributeList);
    }
}
