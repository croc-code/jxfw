...
/**
 * Класс, инкапсулирующий обработку элемента fo:external-graphic.
...
public class ExternalGraphicArea extends GenericArea {
     ...
     */
    public ExternalGraphicArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.EXTERNAL_GRAPHIC, parentArea, attributeList);
    }
}
