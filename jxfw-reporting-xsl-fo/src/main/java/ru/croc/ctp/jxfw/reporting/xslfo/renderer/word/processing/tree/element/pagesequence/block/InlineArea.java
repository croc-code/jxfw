...
/**
 * Класс, инкапсулирующий обработку элемента fo:external-inline.
...
public class InlineArea extends GenericArea {
     ...
     */
    public InlineArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.INLINE, parentArea, attributeList);
    }
}
