 ...
 */
public class PageNumberArea extends GenericArea {
     ...
     */
    public PageNumberArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.PAGE_NUMBER, parentArea, attributeList);
    }
}
