...
/**
 * Класс, инкапсулирующий обработку элемента fo:list-item-body.
...
public class ListItemBodyArea extends GenericArea {
     ...
     */
    public ListItemBodyArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.LIST_ITEM_BODY, parentArea, attributeList);
    }
}