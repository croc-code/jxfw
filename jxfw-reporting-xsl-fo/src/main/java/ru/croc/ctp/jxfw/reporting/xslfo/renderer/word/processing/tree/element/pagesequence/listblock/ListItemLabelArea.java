...
/**
 * Класс, инкапсулирующий обработку элемента fo:list-item-label.
...
public class ListItemLabelArea extends GenericArea {
     ...
     */
    public ListItemLabelArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.LIST_ITEM_LABEL, parentArea, attributeList);
    }
}