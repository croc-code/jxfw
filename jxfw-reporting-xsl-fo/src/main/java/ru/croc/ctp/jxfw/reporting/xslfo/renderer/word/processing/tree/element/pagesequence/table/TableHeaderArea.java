...
/**
 * Класс, инкапсулирующий обработку элемента fo:table-header.
 * Created by vsavenkov on 06.07.2017. Import from $/Крок.R-and-D.ReportRenderers/Sources/Repo-1_1.
 */
public class TableHeaderArea extends GenericArea {
     ...
     */
    public TableHeaderArea(GenericArea parentArea, Map<String, String> attributeList) {
        super(AreaType.TABLE_HEADER, parentArea, attributeList);
    }
}
